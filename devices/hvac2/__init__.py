...
class HVAC(GenericDevice):
    def __init__(self, host, name='generic_hvac', raw_data=None, control_board=None, heat_unit=None, ac_unit=None, vent_unit=None):
        ...
        # self.sock.on('get_current_temp', handler=self.thermostat.get_group_temp)
...
class Thermostat:
    def __init__(self, name, **kwargs):
        ...
        self._default_cool_temp = kwargs.get('default_cool_temp', 77)
        self._temp_diff = kwargs.get('temp_diff', .25)
...
class HVACUnit:
    def __init__(self, unit_type, on_off_pin=None, on_pin=None, off_pin=None, state=None, sock=None):
        """
...
# hvac = HVAC(HOST, control_board=telemetrix.Telemetrix(), heat_unit=HVACUnit('heater', on_pin=4, off_pin=5), ac_unit=HVACUnit('airconditioner', on_pin=6, off_pin=7), vent_unit=HVACUnit('vent', on_pin=2, off_pin=3))
# hvac.startup()
